                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('features') is-invalid @enderror"
                                          ...
                                          name="features"
                                          rows="4"
                                          placeholder="JSON 형식으로 입력하세요. 예: [&quot;특징1&quot;, &quot;특징2&quot;, &quot;특징3&quot;]">{{ old('features', $service->features) }}</textarea>
                                @error('features')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12 mb-3">
                                ...
                                <textarea class="form-control @error('process') is-invalid @enderror"
                                          ...
                                          name="process"
                                          rows="4"
                                          placeholder="JSON 형식으로 입력하세요. 예: [&quot;1단계: 상담&quot;, &quot;2단계: 분석&quot;, &quot;3단계: 제안&quot;]">{{ old('process', $service->process) }}</textarea>
                                @error('process')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('requirements') is-invalid @enderror"
                                          ...
                                          name="requirements"
                                          rows="4"
                                          placeholder="JSON 형식으로 입력하세요. 예: [&quot;요구사항1&quot;, &quot;요구사항2&quot;]">{{ old('requirements', $service->requirements) }}</textarea>
                                @error('requirements')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <textarea class="form-control @error('deliverables') is-invalid @enderror"
                                          ...
                                          name="deliverables"
                                          rows="4"
                                          placeholder="JSON 형식으로 입력하세요. 예: [&quot;결과물1&quot;, &quot;결과물2&quot;]">{{ old('deliverables', $service->deliverables) }}</textarea>
                                @error('deliverables')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                <input class="form-check-input"
                                       ...
                                       name="enable"
                                       value="1"
                                       {{ old('enable', $service->enable) ? 'checked' : '' }}>
